...
pub fn main() {
    ...
    let (prior_max_validator_index, mut membership) = match proof_type {
        ProofType::Initial => (0, BitVec::<u32, Lsb0>::new()),
        ProofType::Continuation {
            prior_max_validator_index,
            ref prior_membership,
            ..
        } => (prior_max_validator_index, prior_membership.clone()),
    };
    ...
    for validator_index in prior_max_validator_index..max_validator_index {
